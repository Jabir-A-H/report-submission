...
# Original file path
FILE_PATH = r"f:\\WebDev\\report-submission\\services\\report_aggregator.py"

NEW_AGGREGATOR = '''from sqlalchemy.orm import joinedload
...
with open(FILE_PATH, 'w', encoding='utf-8') as f:
    f.write(NEW_AGGREGATOR)

print("✅ report_aggregator.py has been thoroughly refactored using Marshmallow + Pandas DataFrames!")
