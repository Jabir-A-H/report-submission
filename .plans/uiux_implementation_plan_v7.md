...
| **Status Tracking** | Static links. | **Automatic Dynamic Badges**: <br> • 🟢 **সম্পন্ন** (Green): All fields filled. <br> • 🟠 **অসম্পূর্ণ** (Orange): Some fields filled. <br> • ⚪ **ফাঁকা** (Grey): No data entered yet. |
...
#### [MODIFY] `src/lib/i18n.ts` — **Updated mappings based on legacy site**
- `header` -> মূল তথ্য
...
- After period is selected, a **7-section card grid** appears below:
  - Cards for: মূল তথ্য, গ্রুপ / কোর্স রিপোর্ট, দাওয়াত ও সংগঠন, ব্যক্তিগত উদ্যোগে তালিমুল কুরআন, বৈঠকসমূহ, মক্তব ও সফর রিপোর্ট, মন্তব্য রিপোর্ট.
  - Each card shows: section icon + Bengali name + completion status badge:
    - 🟢 **সম্পন্ন** (All fields filled)
    - 🟠 **অসম্পূর্ণ** (Started but fields missing)
    - ⚪ **ফাঁকা** (Not started)
  - "রিপোর্ট দেখুন" (View/Start) CTA button to match legacy terminology.
...
- **Admin Quick Actions** (Title: "রিপোর্ট ব্যবস্থাপনা" | Subtitle: "অ্যাডমিন টুলস ও সকল জোন রিপোর্ট"):
  - 🏙️ সিটি রিপোর্ট
  - 👥 ইউজার ম্যানেজমেন্ট
  - 🗺️ জোন ম্যানেজমেন্ট (জোন তালিকা ও জোন যোগ করার সুবিধা)
- **"সকল জোন রিপোর্ট"** section: Paginated table/card list of all reports with filters (zone, type, month/year). Each row has a "দেখুন" button.
